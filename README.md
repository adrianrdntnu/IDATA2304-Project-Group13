...
In [Theory and technology] we go through the theory and technologies we used to implement this solution. We then describe our work proccess in "link to methodology", and our result in "link". In the end we discuss our result in "link" and reflect over possible improvements and future work, in "link".
